        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="company-name" defaultValue="ERP Suite" />
            </div>
            <div className="space-y-2">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Allow usage analytics to improve the product
                </p>
              </div>
              <Switch defaultChecked />
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="from-email" type="email" defaultValue="noreply@company.com" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="email-signature">Email Signature</Label>
              <Textarea id="email-signature" defaultValue="Best regards,\nThe ERP Team" />
            </div>
          </CardContent>
        </Card>
      </div>
